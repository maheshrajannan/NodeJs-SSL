...
# Please refer test/test.js
# Taken from 
#bash make-mahesh-root-ca-and-certificates.sh 'local.ldsconnect.org'
...
openssl req \
  ...
  -subj "/C=US/ST=Utah/L=Provo/O=MAHESHRAJANNAN Signing Authority Inc/CN=maheshrajannan.com"

# Create a Device Certificate for each domain,
# such as maheshrajannan.com, *.maheshrajannan.com, awesome.maheshrajannan.com
...
openssl req -new \
  ...
  -subj "/C=US/ST=Utah/L=Provo/O=MAHESHRAJANNAN Tech Inc/CN=${FQDN}"
